...
rel_dir = '../../data/raw/cases/2017-2018/ILI_weekly_1718_raw.csv'
...
data.to_csv(os.path.join(os.getcwd(),'../../data/interim/cases/2017-2018/ILI_weekly_100K.csv'))
absolute.to_csv(os.path.join(os.getcwd(),'../../data/interim/cases/2017-2018/ILI_weekly_ABS.csv'))
